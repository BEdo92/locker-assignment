...
### Locker Sections
The changing room is divided into rows of lockers.
...
### Group Assignments
When multiple guests arrive together (e.g., a family or friends), the system attempts to assign lockers next to each other.

## Current Status

### Interface
The application is built as a Command-Line Interface (CLI).
